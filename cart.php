...
<body>
    ...
    <section>
        <section id="cart_items">
            <div class="container">
                <h3 style="text-align: center;font-size: -webkit-xxx-large;" >GIỎ HÀNG CỦA BẠN</h3>
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        <thead>
                            <tr class="cart_menu" style=" background: #24a0f8;text-align: center;">
                                <td class="image"></td>
                                        ...
                                        foreach ($product->getProductsByID($numberID) as $value) { ?>
                                            ...
                                            <td class="cart_quantity">
                                                <div class="cart_quantity_button">
                                                    <a style="background: #09c16c;" class="cart_quantity_up" href="change.php?id=<?php echo $numberID ?>&control=1"> + </a>
                                                    <input class="cart_quantity_input" type="text" name="quantity" value="<?php echo $_SESSION['cart'][$numberID] ?>" autocomplete="off" size="2">
                                                    <a style="background: #fe0c0c;" class="cart_quantity_down" href="change.php?id=<?php echo $numberID ?>&control=2"> - </a>
                                                </div>
                                            </td>
                                            <td class="cart_total">
                ...
                <!--Form dat hang-->
                    ...
                    <h3>
                        <p style="text-align:center;background-color:#24a0f8;padding:10px;color:white;">Tổng Cộng: <?php echo number_format($total) ?> VND</p>
                    </h3>
                    <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="thanhtoan.php">
                        ...
                        <div class="form-group col-md-12">
                            <a class="btn btn-default update" href="index.php" style="background: #19c89f;">Tiếp tục mua hàng</a>
                            <a class="btn btn-default check_out" href="change.php?control=4" style="background: #ff0000;">Xóa tất cả</a>
                            <input type="submit" name="submitOrder" class="btn btn-primary pull-right" value="Đặt hàng" style="background: #2bd800;">
