                ...
                <div class="navbar-header">
                    ...
                    <div class="logo">
                        <a href="index.php">
                            ...
                            <a href="index.php" class="logo_name">Electronic Store</a>
                        </a>
                    </div>
                </div>
                <div class="mainmenu pull-right">
                    <ul class="nav navbar-nav collapse navbar-collapse">
                        ...
                        <li>
                            ...
                            <a href="./Login/index.php" style="font-size:20px; margin-bottom:-20px"><i
                            ...
                            <i class="fas fa-user-tie"></i> : <span style="padding-right: 12px; color:yellow"><?=$_SESSION['customer_name']?></span>
                                ...
                                <a style="font-size:20px; margin-bottom:-20px" href='./Login/logout.php'>
